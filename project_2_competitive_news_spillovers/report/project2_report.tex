...
\title{Contagion or Competition?\\An LLM-Based Event Study of Corporate News Spillovers Across Competitor Stocks}
\author{}
\date{}
...
\section{Question Description \& Theory Basis}
...
This design fits naturally within the event-study tradition in finance. Event studies use abnormal returns to test whether new information is associated with unusual stock-price movement relative to a benchmark \cite{fama1969,brownwarner1985,mackinlay1997}. The present project extends that logic from focal firms to competitor networks. The target is not the direct price reaction of the company in the headline, but the reaction of rival firms in the same predefined competitive group.
...
\begin{itemize}
    \item H1: Relevant corporate news is associated with measurable abnormal returns among competitor firms.
    \item H2: News classified as industry-wide or same-direction contagion is associated with same-direction competitor stock reactions.
    \item H3: News classified as firm-specific competitive advantage is more likely to generate opposite-direction competitor stock reactions.
\end{itemize}
...
\section{Data Collection \& Basic Analysis}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.9\textwidth]{figures/figure1_dataset_construction.png}
    \caption{Dataset construction from raw news rows to the final competitor event panel.}
\end{figure}
...
\section{Application of LLM Models}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.88\textwidth]{figures/figure2_llm_relevance_distribution.png}
    \caption{Distribution of relevance-type labels in the LLM-classified sample.}
\end{figure}
...
\subsection*{Empirical regression model}
...
\[
Y_{e,i} = \alpha + \beta_1 Label_e + \gamma' Controls_{e,i} + \varepsilon_{e,i}
\]
...
\begin{table}[H]
    \centering
    \caption{Event sample definitions.}
    \small
    \begin{tabular}{>{\raggedright\arraybackslash}p{0.2\textwidth} >{\raggedright\arraybackslash}p{0.55\textwidth} r}
        \toprule
        ...
        Very strict sample & Strict sample plus materiality \(\geq 3\) and confidence \(\geq 4\) & 2,273 \\
        \bottomrule
    \end{tabular}
\end{table}
...
\begin{table}[H]
    \centering
    \includegraphics[width=\textwidth]{figures/table5_main_empirical_results.png}
    \caption{Main empirical results.}
\end{table}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.9\textwidth]{figures/figure3_mean_return_by_expected_effect.png}
    \caption{Mean next-day competitor abnormal return by expected competitor-effect label.}
\end{figure}
...
\bibitem{loughranmcdonald2011}
Loughran, T., \& McDonald, B. (2011).
When is a liability not a liability? Textual analysis, dictionaries, and 10-Ks.
\textit{The Journal of Finance, 66}(1), 35--65.
